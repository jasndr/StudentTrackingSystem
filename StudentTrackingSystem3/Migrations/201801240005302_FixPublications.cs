namespace StudentTrackingSystem3.Migrations
{
    ...
    public partial class FixPublications : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.G_Activity", t => t.ActivityID)
                .ForeignKey("dbo.G_CurriculumVitae", t => t.CurriculumVitaeID)
                .ForeignKey("dbo.G_Manuscript", t => t.ManuscriptID)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.G_CommonFields", t => t.GrantMonthId)
                .ForeignKey("dbo.G_Student", t => t.StudentID, cascadeDelete: true)
                .ForeignKey("dbo.G_CommonFields", t => t.G_CommonFields_ID)
                .Index(t => t.StudentID)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.G_CommonFields", t => t.PubMonthId)
                .ForeignKey("dbo.G_Student", t => t.StudentID, cascadeDelete: true)
                .ForeignKey("dbo.G_CommonFields", t => t.G_CommonFields_ID)
                .Index(t => t.StudentID)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.G_File", "ManuscriptID", "dbo.G_Manuscript");
            ...
            DropForeignKey("dbo.G_Publications", "G_CommonFields_ID", "dbo.G_CommonFields");
            ...
            DropForeignKey("dbo.G_Grants", "G_CommonFields_ID", "dbo.G_CommonFields");
            ...
            DropForeignKey("dbo.G_File", "CurriculumVitaeID", "dbo.G_CurriculumVitae");
            DropForeignKey("dbo.G_File", "ActivityID", "dbo.G_Activity");
            DropIndex("dbo.G_PersonRaces", new[] { "RaceID" });
            DropIndex("dbo.G_PersonRaces", new[] { "StudentID" });
            DropIndex("dbo.G_Manuscript", new[] { "StudentID" });
            DropIndex("dbo.G_Publications", new[] { "G_CommonFields_ID" });
            ...
            DropIndex("dbo.G_Grants", new[] { "G_CommonFields_ID" });
